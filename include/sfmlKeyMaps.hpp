...
inline static const std::vector<std::string> keyNames = {
    "Unknown", 
    "A",       
    "B",       
    "C",       
...
inline static const std::unordered_map<std::string, sf::Keyboard::Key> keyMap = {
...
inline static const std::unordered_map<sf::Keyboard::Key, std::string> keyNameMap = {
...
inline static const std::vector<std::string> buttonNames = {
    "Left",  
    "Right", 
    "Middle",
    "Extra1",
...
inline static const std::unordered_map<std::string, sf::Mouse::Button> buttonMap = {
...
inline static const std::unordered_map<sf::Mouse::Button, std::string> buttonNameMap = {
    {sf::Mouse::Button::Left,       "Left"},
    {sf::Mouse::Button::Right,      "Right"},
    {sf::Mouse::Button::Middle,     "Middle"},
    {sf::Mouse::Button::Extra1,     "Extra1"},
    {sf::Mouse::Button::Extra2,     "Extra2"}
};